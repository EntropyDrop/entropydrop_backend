...
Use the user-provided backend origin and spaceAPI key. Send the key only to that backend in the Authorization header. Do not put it in a URL, generated code, or a public artifact. Model-provider API keys are separate from spaceAPI credentials.
